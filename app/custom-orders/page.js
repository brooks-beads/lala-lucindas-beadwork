...
export default async function CustomOrdersPage() {
  ...
  return (
    <main className="bg-earth-50 min-h-screen">
      ...
      {/* Hero */}
      <section className="bg-earth-900 text-earth-50 py-20 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <p className="section-label text-earth-400 mb-4">Custom Orders</p>
          <h1 className="text-4xl md:text-5xl font-light tracking-wide text-earth-50 leading-tight mb-6">
            Made for you,<br />start to finish.
          </h1>
          <p className="text-earth-300 font-light leading-relaxed text-base md:text-lg">
      ...
      <section className="py-16 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-earth-500 font-light text-sm mb-10 leading-relaxed">
      ...
      {/* Policy notes */}
      <section className="bg-earth-100 border-t border-b border-earth-200 py-14 px-6">
        <div className="max-w-2xl mx-auto">
          <p className="section-label mb-4">A couple things to know</p>
          <ul className="space-y-5">
            <li className="flex gap-4">
              <span className="text-clay mt-1 shrink-0">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </span>
              <p className="text-earth-700 font-light text-sm leading-relaxed">
                <span className="font-normal text-earth-900">All custom orders require 50% down, 50% upon completion.</span>{' '}
            ...
            <li className="flex gap-4">
              ...
              <p className="text-earth-700 font-light text-sm leading-relaxed">
                <span className="font-normal text-earth-900">No returns or refunds on custom pieces —</span>{' '}
      ...
      <section className="py-16 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <blockquote className="relative">
            <svg
              className="absolute -top-4 -left-2 w-10 h-10 text-earth-200"
              fill="currentColor"
              viewBox="0 0 32 32"
            >
              <path d="M10 8C5.6 8 2 11.6 2 16v8h8v-8H6c0-2.2 1.8-4 4-4V8zm14 0c-4.4 0-8 3.6-8 8v8h8v-8h-4c0-2.2 1.8-4 4-4V8z" />
            </svg>
            <p className="text-earth-800 text-base md:text-lg font-light leading-relaxed pl-8 italic">
            ...
            <footer className="mt-6 pl-8">
              <p className="text-xs tracking-widest uppercase text-earth-500">— Custom order customer</p>
            </footer>
          </blockquote>
        </div>
      </section>
      ...
      <section className="bg-earth-900 py-16 px-6">
        <div className="max-w-screen-xl mx-auto">
          <div className="text-center mb-12">
            <p className="section-label text-earth-400 mb-3">Previous Custom Work</p>
            <h2 className="text-3xl font-light tracking-wide text-earth-50">
          ...
          {gallery.length > 0 ? (
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {gallery.map((item) => (
                <div key={item.id} className="aspect-square relative overflow-hidden group">
                  ...
                  />
                  {item.name && (
                    <div className="absolute inset-0 bg-earth-900/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
                      <p className="text-earth-100 text-xs tracking-wide font-light">{item.name}</p>
                    </div>
                  )}
                </div>
              ))}
            ...
            <div className="text-center py-12">
              <p className="text-earth-400 font-light text-sm leading-relaxed max-w-md mx-auto">
                Gallery coming soon — in the meantime, browse the{' '}
                <a href="/#shop" className="underline text-earth-300 hover:text-earth-100 transition-colors">
                  shop
                </a>{' '}
      ...
      <section className="py-16 px-6 text-center">
        <p className="text-earth-500 font-light text-sm mb-2">Ready to get started?</p>
        <h3 className="text-2xl font-light tracking-wide text-earth-900 mb-6">
